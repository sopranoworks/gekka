...
// Extension modules used only in test/integration/plugin_test.go.
// Resolved from the workspace via the replace directives below.
require (
...
replace (
	github.com/sopranoworks/gekka-extensions-cluster-k8s => ./extensions/cluster/k8s
	github.com/sopranoworks/gekka-extensions-persistence-spanner => ./extensions/persistence/spanner
	github.com/sopranoworks/gekka-extensions-telemetry-otel => ./extensions/telemetry/otel
)
