# v0.14.0 Refactoring — Ultra Thin Core Audit
...
1. **v0.14.0** (current): Fix OTel imports in core packages (journal, region, projection).  Create extension skeletons.
...
6. **v0.14.0** (release): Root `go.mod` contains only: `google.golang.org/protobuf`, `gopkg.in/yaml.v3`, `github.com/sopranoworks/gekka-config`, `github.com/stretchr/testify`, `github.com/spf13/cobra`, Charmbracelet UI libs.

---

## Definition of Done for v0.14.0
