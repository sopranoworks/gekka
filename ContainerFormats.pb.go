...
type StatusReplyErrorMessage struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *StatusReplyErrorMessage) Reset() {
	*x = StatusReplyErrorMessage{}
	mi := &file_ContainerFormats_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StatusReplyErrorMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StatusReplyErrorMessage) ProtoMessage() {}

func (x *StatusReplyErrorMessage) ProtoReflect() protoreflect.Message {
	mi := &file_ContainerFormats_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StatusReplyErrorMessage.ProtoReflect.Descriptor instead.
func (*StatusReplyErrorMessage) Descriptor() ([]byte, []int) {
	return file_ContainerFormats_proto_rawDescGZIP(), []int{12}
}

func (x *StatusReplyErrorMessage) GetErrorMessage() string {
...
const file_ContainerFormats_proto_rawDesc = "" +
	"\n" +
	"\x16ContainerFormats.proto\"\xd9\x01\n" +
	...
	"\apattern\x18\x03 \x03(\v2\n" +
	".SelectionR\apattern\x12(\n" +
	"\x0fmessageManifest\x18\x04 \x01(\fR\x0fmessageManifest\x12&\n" +
	"\x0ewildcardFanOut\x18\x05 \x01(\bR\x0ewildcardFanOut\"G\n" +
	"\tSelection\x12 \n" +
	"\x04type\x18\x01 \x02(\x0e2\f.PatternTypeR\x04type\x12\x18\n" +
	"\amatcher\x18\x02 \x01(\tR\amatcher\"2\n" +
	"\bIdentify\x12&\n" +
	"\tmessageId\x18\x01 \x02(\v2\b.PayloadR\tmessageId\"\\\n" +
	"\rActorIdentity\x12.\n" +
	"\rcorrelationId\x18\x01 \x02(\v2\b.PayloadR\rcorrelationId\x12\x1b\n" +
	"\x03ref\x18\x02 \x01(\v2\t.ActorRefR\x03ref\"\x1e\n" +
	"\bActorRef\x12\x12\n" +
	"\x04path\x18\x01 \x02(\tR\x04path\"(\n" +
	"\x06Option\x12\x1e\n" +
	"\x05value\x18\x01 \x01(\v2\b.PayloadR\x05value\"\x81\x01\n" +
	"\aPayload\x12(\n" +
	"\x0fenclosedMessage\x18\x01 \x02(\fR\x0fenclosedMessage\x12\"\n" +
	"\fserializerId\x18\x02 \x02(\x05R\fserializerId\x12(\n" +
	"\x0fmessageManifest\x18\x04 \x01(\fR\x0fmessageManifest\",\n" +
	"\x18WatcherHeartbeatResponse\x12\x10\n" +
	"\x03uid\x18\x01 \x02(\x04R\x03uid\"\x97\x01\n" +
	"\tThrowable\x12\x1c\n" +
	"\tclassName\x18\x01 \x02(\tR\tclassName\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12\x1e\n" +
	"\x05cause\x18\x03 \x01(\v2\b.PayloadR\x05cause\x122\n" +
	"\n" +
	"stackTrace\x18\x04 \x03(\v2\x12.StackTraceElementR\n" +
	"stackTrace\"\x8c\x01\n" +
	...
	"\x11originalClassName\x18\x03 \x02(\tR\x11originalClassName\"y\n" +
	"\x1cActorInitializationException\x12\x1f\n" +
	"\x05actor\x18\x01 \x01(\v2\t.ActorRefR\x05actor\x12\x18\n" +
	"\amessage\x18\x02 \x02(\tR\amessage\x12\x1e\n" +
	"\x05cause\x18\x03 \x02(\v2\b.PayloadR\x05cause\"\x8d\x01\n" +
	...
	"lineNumber\"=\n" +
	"\x17StatusReplyErrorMessage\x12\"\n" +
	"\ferrorMessage\x18\x01 \x02(\tR\ferrorMessage*<\n" +
	"\vPatternType\x12\n" +
	"\n" +
	"\x06PARENT\x10\x00\x12\x0e\n" +
	"\n" +
	"CHILD_NAME\x10\x01\x12\x11\n" +
	"\rCHILD_PATTERN\x10\x02B\x1b\n" +
...
var file_ContainerFormats_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_ContainerFormats_proto_goTypes = []any{
	...
	(*StatusReplyErrorMessage)(nil),      // 13: StatusReplyErrorMessage
}
